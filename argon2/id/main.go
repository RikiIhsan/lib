...
func CreateHash(password string, params *Params) (hash string, err error) {
	...
	hash = fmt.Sprintf("$asrsargon2id$ver=%d$memo=%d,it=%d,pll=%d$%s$%s", argon2.Version, params.Memory, params.Iterations, params.Parallelism, base64salt, base64key)
	return hash, nil
}
